...
@CustomLog
public class MeasureShape extends MeasureCommand {
	...
	public Object execute( CommandContext context, Object... parameters ) throws Exception {
		...
		try {
			...
			String description = shape.toString();

			String title = Rb.text( BundleKey.NOTICE, "measurement" );
			String message = shape == DesignShape.NONE ? Rb.text( BundleKey.NOTICE, "shape-not-selected" ) : Rb.text( BundleKey.NOTICE, "shape", description );
