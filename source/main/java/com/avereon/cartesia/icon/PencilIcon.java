...
public class PencilIcon extends SvgIcon {
	...
	protected void doRender() {
		...
		fill( "M24,4L25,3A2,1,45,0,1,29,7L28,8Z", Color.HOTPINK );
		draw( "M3,29L7,21L25,3A2,1,45,0,1,29,7L11,25Z M24,4L28,8 M22,6L26,10 M7,21L7,23L9,23L9,25L11,25", null, 1, StrokeLineCap.BUTT, StrokeLineJoin.MITER );
		super.doRender();
	}
