...
public class DrawEllipse3Test extends BaseCommandTest {

	private final DrawEllipse3 command = new DrawEllipse3();
	...
	void testRunTaskStepWithAllParametersUsingRadii() throws Exception {
		// given
		CommandTask task = new CommandTask( commandContext, tool, null, null, command, "8,3", "7", "5" );
	...
	private static Stream<Arguments> provideParametersForTestWithParameters() {
		return Stream.of(
			...
			Arguments.of( new String[]{ "1,3", "2,3", "bad parameter" }, "radius" )
		);
	}
