...
public class DrawArc2Test extends CommandBaseTest {
	...
	void testRunTaskStepWithFourParameters() throws Exception {
		// given
		CommandTask task = new CommandTask( commandContext, tool, null, null, command, "0,0", "1,0", "1,1", "0" );
	...
	void testRunTaskStepWithTwoStep() throws Exception {
		...
		CommandTask task1 = new CommandTask( commandContext, tool, null, null, command );
		task1.runTaskStep();
		CommandTask task2 = new CommandTask( commandContext, tool, null, null, command, "0,0" );
		task2.runTaskStep();
	...
	void testRunTaskStepWithThreeSteps() throws Exception {
		...
		CommandTask task2 = new CommandTask( commandContext, tool, null, null, command, "0,0" );
		task2.runTaskStep();
		CommandTask task3 = new CommandTask( commandContext, tool, null, null, command, "0,0", "1,0" );
		task3.runTaskStep();
