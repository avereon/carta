...
public class CadShapesTest {
	...
	void testCartesianToPolar() {
		Point3DAssert.assertThat( CadShapes.cartesianToPolarDegrees( new Point3D( 1, 0, 0 ) ) ).isCloseTo( new Point3D( 1, 0, 0 ) );
		Point3DAssert.assertThat( CadShapes.cartesianToPolarDegrees( new Point3D( 0, 1, 0 ) ) ).isCloseTo( new Point3D( 1, 90, 0 ) );
		Point3DAssert.assertThat( CadShapes.cartesianToPolarDegrees( new Point3D( -1, 0, 0 ) ) ).isCloseTo( new Point3D( 1, 180, 0 ) );
		Point3DAssert.assertThat( CadShapes.cartesianToPolarDegrees( new Point3D( 0, -1, 0 ) ) ).isCloseTo( new Point3D( 1, -90, 0 ) );
	}

	@Test
	void testPolarToCartesian() {
		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( 1, 0, 0 ) ) ).isCloseTo( new Point3D( 1, 0, 0 ) );
		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( 1, 90, 0 ) ) ).isCloseTo( new Point3D( 0, 1, 0 ) );
		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( 1, 180, 0 ) ) ).isCloseTo( new Point3D( -1, 0, 0 ) );
		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( 1, 270, 0 ) ) ).isCloseTo( new Point3D( 0, -1, 0 ) );
		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( 1, 360, 0 ) ) ).isCloseTo( new Point3D( 1, 0, 0 ) );

		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( Constants.SQRT_TWO, 45, 0 ) ) ).isCloseTo( new Point3D( 1, 1, 0 ) );
		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( Constants.SQRT_TWO, 135, 0 ) ) ).isCloseTo( new Point3D( -1, 1, 0 ) );
		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( Constants.SQRT_TWO, 225, 0 ) ) ).isCloseTo( new Point3D( -1, -1, 0 ) );
		Point3DAssert.assertThat( CadShapes.polarDegreesToCartesian( new Point3D( Constants.SQRT_TWO, 315, 0 ) ) ).isCloseTo( new Point3D( 1, -1, 0 ) );
	...
	void testParsePolarCoordinates() {
		Point3DAssert.assertThat( CadShapes.parsePoint( "<0,1" ) ).isCloseTo( new Point3D( 1, 0, 0 ) );
		Point3DAssert.assertThat( CadShapes.parsePoint( "<90,1" ) ).isCloseTo( new Point3D( 0, 1, 0 ) );
		Point3DAssert.assertThat( CadShapes.parsePoint( "<180,1" ) ).isCloseTo( new Point3D( -1, 0, 0 ) );
		Point3DAssert.assertThat( CadShapes.parsePoint( "<3*180/2,1" ) ).isCloseTo( new Point3D( 0, -1, 0 ) );

		Point3DAssert.assertThat( CadShapes.parsePoint( "<90,1" ) ).isCloseTo( new Point3D( 0, 1, 0 ) );
		Point3DAssert.assertThat( CadShapes.parsePoint( "<180,1" ) ).isCloseTo( new Point3D( -1, 0, 0 ) );
		Point3DAssert.assertThat( CadShapes.parsePoint( "<270,1" ) ).isCloseTo( new Point3D( 0, -1, 0 ) );

		Point3DAssert.assertThat( CadShapes.parsePoint( "<45,1" ) ).isCloseTo( new Point3D( java.lang.Math.cos( Constants.PI_OVER_4 ), java.lang.Math.sin( Constants.PI_OVER_4 ), 0 ) );
	}

	@Test
	void testParsePolarCoordinatesAngleSeparator() {
		Point3DAssert.assertThat( CadShapes.parsePoint( "1<0" ) ).isCloseTo( new Point3D( 1, 0, 0 ) );
	}
	...
	void testParsePointWithWhitespace() {
		Point3D anchor = new Point3D( 1, 1, 0 );
		assertThat( CadShapes.parsePoint( " 1 , 2 " ) ).isEqualTo( new Point3D( 1, 2, 0 ) );
		Point3DAssert.assertThat( CadShapes.parsePoint( " pi , 1 " ) ).isCloseTo( new Point3D( Math.PI, 1, 0 ) );
		Point3DAssert.assertThat( CadShapes.parsePoint( " <180 , 1 " ) ).isCloseTo( new Point3D( -1, 0, 0 ) );
