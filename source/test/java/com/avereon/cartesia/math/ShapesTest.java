...
public class ShapesTest {
	...
	void testParsePolarCoordinates() {
		...
		assertThat( Shapes.parsePoint( ">rad(45),1" ), near( new Point3D( java.lang.Math.cos( Constants.PI_OVER_4 ), java.lang.Math.sin( Constants.PI_OVER_4 ), 0 ) ) );
	}

	@Test
	void testParseRelativePolarCoordinates() {
		Point3D anchor = new Point3D( 1, 1, 0 );
		assertThat( Shapes.parsePoint( "@<1,rad(180+45)", anchor ), near( new Point3D( 1 - java.lang.Math.cos( Constants.PI_OVER_4 ), 1 - java.lang.Math.sin( Constants.PI_OVER_4 ), 0 ) ) );
		assertThat( Shapes.parsePoint( "@>rad(180+45),1", anchor ), near( new Point3D( 1 - java.lang.Math.cos( Constants.PI_OVER_4 ), 1 - java.lang.Math.sin( Constants.PI_OVER_4 ), 0 ) ) );
	...
	void testFindNearestShapeToPointWithLines() {
		...
		assertThat( Shapes.findNearestShapeToPoint( Set.of( a, b ), new Point3D( 0, -0.25, 0 ) ), is( a ) );
		assertThat( Shapes.findNearestShapeToPoint( Set.of( a, b ), new Point3D( 0, 0, 0 ) ), is( a ) );
		assertThat( Shapes.findNearestShapeToPoint( Set.of( a, b ), new Point3D( 0, 0.25, 0 ) ), is( a ) );
		assertThat( Shapes.findNearestShapeToPoint( Set.of( a, b ), new Point3D( 0, 0.5, 0 ) ), oneOf( a, b ) );
		assertThat( Shapes.findNearestShapeToPoint( Set.of( a, b ), new Point3D( 0, 0.75, 0 ) ), is( b ) );
		assertThat( Shapes.findNearestShapeToPoint( Set.of( a, b ), new Point3D( 0, 1.0, 0 ) ), is( b ) );
		assertThat( Shapes.findNearestShapeToPoint( Set.of( a, b ), new Point3D( 0, 1.25, 0 ) ), is( b ) );
	}
